...
//#include "HardwareProfilePinguino440.h"
#define UBW32
// #define PINGUINO_220
// #define PINGUINO_440
// #define FUBARINO
    ...
    #if defined(__C32__)
        #if defined(__32MX460F512L__) || defined(__32MX795F512L__) || defined(__32MX220F032D__) || defined(__32MX440F256H__) || defined(__32MX795F512H__) 
                ...
                #include "HardwareProfileFubarino.h"
			#elif defined (PINGUINO_220)
				#include "HardwareProfilePinguino220.h"
			#elif defined (PINGUINO_440)
				#include "HardwareProfilePinguino440.h"
            #endif
        #endif
    #endif
